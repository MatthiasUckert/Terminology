...
We exclude accounting terms which also have a (different) meaning in *general* language (e.g., \"entry\") and which we identify with the *2of12inf*
dictionary which is a word list that includes more than 80,000 words (See Loughran and McDonald, 2011, 2016).
